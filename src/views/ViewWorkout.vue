<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item, index) in data.exercises"
            ...
            <div class="flex flex-2 flex-col md:1/3">
              <label for="exercises-name" class="mb-1 text-sm text-at-light-green">
                Exercises
              </label>
              <input v-if="edit" id="exercises-name" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="sets" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
                v-model="item.sets" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="reps" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
                v-model="item.reps" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="weight" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
                v-model="item.weight" />
              <p v-else>{{ item.weight }}</p>
            </div>
            <img v-if="edit" @click="deleteExercise(item.id)" src="@/assets/images/trash-light-green.png"
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item, index) in data.exercises"
            ...
            <div class="flex flex-2 flex-col md:1/3">
              ...
              <select v-if="edit" id="cardioType" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="distance" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="duration" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="pace" class="p-2 w-full text-gray-500 focus:ouline-none" type="text"
                v-model="item.pace" />
      ...
      <!-- Update -->
      <button v-if="edit" @click="update" type="submit"
  ...
  setup() {
    ...
    const deleteExercise = (id) => {
      if (data.value.exercises.length > 1) {
        data.value.exercises = data.value.exercises.filter((exercises) => exercises.id !== id);
        return
      }
    ...
    return { data, dataLoaded, errorMsg, route, statusMsg, edit, editMode, user, deleteWorkout, addExercise, deleteExercise, update };
  },
};
</script>
